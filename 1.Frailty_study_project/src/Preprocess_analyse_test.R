...
data <- read.csv("/Users/anveshkumar/Desktop/frailty_study_project/data_raw/raw_frailty_data1.csv")
...
write.csv(data, "/Users/anveshkumar/Desktop/frailty_study_project/data_clean/clean_frality_data.csv", row.names=FALSE)
...
data2 <- read.csv("/Users/anveshkumar/Desktop/frailty_study_project/data_clean/clean_frality_data.csv")
...
writeLines(result_text, "/Users/anveshkumar/Desktop/frailty_study_project/results/test_results.txt")
